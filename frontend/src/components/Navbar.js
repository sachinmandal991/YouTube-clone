  ...
  return (
    <nav style={styles.nav}>
      <div style={styles.leftSection}>
        <div style={styles.menuIcon} onClick={() => setIsSidebarOpen(!isSidebarOpen)}>
          <svg height="24" viewBox="0 0 24 24" width="24" fill="#fff">
            <path d="M3 18h18v-2H3v2zm0-5h18v-2H3v2zm0-7v2h18V6H3z"/>
          </svg>
        </div>
        <Link to="/" style={styles.logo}>
        <svg viewBox="0 0 90 20" style={styles.logoSvg}>
          ...
          <path d="M41.4697 18.1937C40.9053 17.8127 40.5031 17.22 40.2632 16.4157C40.0257 15.6114 39.9058 14.5437 39.9058 13.2078V11.3898C39.9058 10.0422 40.0422 8.95805 40.315 8.14196C40.5878 7.32588 41.0135 6.72851 41.592 6.35457C42.1706 5.98063 42.9302 5.79248 43.871 5.79248C44.7976 5.79248 45.5384 5.98298 46.0981 6.36398C46.6555 6.74497 47.0508 7.34234 47.2765 8.15137C47.5023 8.95805 47.6176 10.0422 47.6176 11.3898V13.2078C47.6176 14.5437 47.5023 15.6161 47.2765 16.4251C47.0508 17.2365 46.6508 17.8292 46.0887 18.2031C45.5266 18.5771 44.7764 18.7652 43.8357 18.7652C42.8831 18.7675 42.0365 18.5747 41.4697 18.1937ZM44.6353 16.2323C44.7905 15.8231 44.8705 15.1575 44.8705 14.2309V10.3292C44.8705 9.43077 44.7929 8.77225 44.6353 8.35833C44.4777 7.94206 44.2026 7.7351 43.8074 7.7351C43.4265 7.7351 43.156 7.94206 43.0008 8.35833C42.8432 8.77461 42.7656 9.43077 42.7656 10.3292V14.2309C42.7656 15.1575 42.8408 15.8254 42.9914 16.2323C43.1419 16.6415 43.4123 16.8461 43.8074 16.8461C44.2026 16.8461 44.4777 16.6415 44.6353 16.2323Z" fill="white"/>
      ...
      <form onSubmit={handleSearch} style={styles.searchForm}>
        ...
        <button type="button" onClick={handleVoiceSearch} style={{...styles.voiceButton, ...(isListening ? styles.voiceActive : {})}}>
          <svg height="24" viewBox="0 0 24 24" width="24" fill="#fff">
      ...
      <div style={styles.links}>
        {token ? (
          <>
            <button style={styles.createButton} onClick={() => setShowCreateMenu(!showCreateMenu)}>
              <svg height="24" viewBox="0 0 24 24" width="24" style={styles.createIcon}>
            ...
            {showCreateMenu && (
              <div style={styles.dropdown}>
                <div style={styles.dropdownItem} onClick={() => { navigate('/upload'); setShowCreateMenu(false); }}>
                  <svg height="20" viewBox="0 0 24 24" width="20" style={styles.dropdownIcon}>
            ...
            <div style={styles.profileButton} onClick={() => setShowProfileMenu(!showProfileMenu)}>
            ...
            {showProfileMenu && (
              <div style={styles.profileDropdown}>
                <div style={styles.profileHeader}>
                  <svg height="40" viewBox="0 0 24 24" width="40" style={styles.profileIcon}>
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"/>
                  </svg>
                  <div>
                    <div style={styles.username}>{localStorage.getItem('username')}</div>
                    <div style={styles.email}>@{localStorage.getItem('username')}</div>
                  </div>
                </div>
                <div style={styles.divider}></div>
                <div style={styles.menuItem}>
                  <svg height="20" viewBox="0 0 24 24" width="20" style={styles.menuIcon}>
                    <path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 3c1.66 0 3 1.34 3 3s-1.34 3-3 3-3-1.34-3-3 1.34-3 3-3zm0 14.2c-2.5 0-4.71-1.28-6-3.22.03-1.99 4-3.08 6-3.08 1.99 0 5.97 1.09 6 3.08-1.29 1.94-3.5 3.22-6 3.22z"/>
                  </svg>
                  Google Account
                </div>
                ...
                <div style={styles.menuItem}>
                  <svg height="20" viewBox="0 0 24 24" width="20" style={styles.menuIcon}>
                    <path d="M12 22c4.97 0 9-4.03 9-9-4.97 0-9 4.03-9 9zM5.6 10.25c0 1.38 1.12 2.5 2.5 2.5.53 0 1.01-.16 1.42-.44l-.02.19c0 1.38 1.12 2.5 2.5 2.5s2.5-1.12 2.5-2.5l-.02-.19c.4.28.89.44 1.42.44 1.38 0 2.5-1.12 2.5-2.5 0-1-.59-1.85-1.43-2.25.84-.4 1.43-1.25 1.43-2.25 0-1.38-1.12-2.5-2.5-2.5-.53 0-1.01.16-1.42.44l.02-.19C14.5 2.12 13.38 1 12 1S9.5 2.12 9.5 3.5l.02.19c-.4-.28-.89-.44-1.42-.44-1.38 0-2.5 1.12-2.5 2.5 0 1 .59 1.85 1.43 2.25-.84.4-1.43 1.25-1.43 2.25zM12 5.5c1.38 0 2.5 1.12 2.5 2.5s-1.12 2.5-2.5 2.5S9.5 9.38 9.5 8s1.12-2.5 2.5-2.5zM3 13h2c0 3.31 2.69 6 6 6v2c-4.42 0-8-3.58-8-8z"/>
                  </svg>
